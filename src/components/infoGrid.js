...
export default function InfoGrid(props) {
  ...
  return (
    <div className="grid grid-cols-2 m-8 gap-4 mx-auto md:w-3/5">
      ...
      <div className="bg-gray-300 p-2 rounded-lg flex justify-evenly gap-x-2 items-center">
        <div>
          <span className="text-[1.2rem] text-blue-400"><FontAwesomeIcon icon={faWind} /></span>
        </div>
        <div className="text-center">
            <h1 className="text-gray-400 text-[0.8rem]">Wind Speed</h1>
      ...
      <div className="bg-gray-300 p-2 rounded-lg flex justify-evenly gap-x-2 items-center">
        ...
        <div className="text-center">
            <h1 className="text-gray-400 text-[0.8rem]">Humidity</h1>
      ...
      <div className="bg-gray-300 p-2 rounded-lg flex justify-evenly gap-x-2 items-center">
        ...
        <div className="text-center">
            <h1 className="text-gray-400 text-[0.8rem]">Pressure</h1>
      ...
      <div className="bg-gray-300 p-2 rounded-lg flex justify-evenly gap-x-2 items-center">
        ...
        <div className="text-center">
            <h1 className="text-gray-400 text-[0.8rem]">Visibility</h1>
